...
bibliography: baum-zhou-revision.bib
...
* \code{zmodels} is a list of fited \code{lm} or \code{glm} objects for post-treatment confounders of the mediator-outcome relationship. Users should set this argument to \code{NULL} if there are no post-treatment confounders.
